define(['app/app',
    'loadash',
    'app/extpendingcpd/service/extpendingcpd-service'
], function (app, _, extpendingcpdsvc) {
    'use strict';
    app.register.controller('extpendingcpdCtrl', ['$scope', '$state', '$mdDialog', 'extpendingcpdsvc', '$filter', '$window', function ($scope, $state, $mdDialog, extpendingcpdsvc, $filter, $window) {

        var vm = this;

        var service = extpendingcpdsvc;
