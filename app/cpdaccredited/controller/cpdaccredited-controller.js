define(['app/app',
    ...
    'use strict';
    app.register.controller('cpdaccredtCtrl', ['$scope', '$http', '$window', function ($scope, $http, $window) {
        ...
        function loadData() {
            ...
            $http.get(configenum.USER.APPROVEDCPD, { params: clean(vm.pagingInfo) }).then(successCallback, errorCallback);
        }
        ...
        vm.DownloadExcel = function () {
            var file = configenum.USER.APPROVEDCPDEXCEL;
